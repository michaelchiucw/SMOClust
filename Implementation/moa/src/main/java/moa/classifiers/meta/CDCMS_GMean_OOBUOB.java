...
//            horizonOption = null;
	...
	public void resetLearningImpl() {
		...
		this.ensemble_NL = new EnsembleWithInfo(this.fadingFactorOption.getValue(), this.numClasses, this.classifierRandom, this.thetaOption.getValue(), this.isUOBOption.isSet(), true, "NL");
...
//				System.out.println("OUTCONTROL | " + super.trainingWeightSeenByModel);
				...
				this.ensemble_NH = new EnsembleWithInfo(this.fadingFactorOption.getValue(), this.numClasses, this.classifierRandom, this.thetaOption.getValue(), this.isUOBOption.isSet(), false, "NH");
...
//				this.driftDetector.resetLearning();
	...
	protected class EnsembleWithInfo extends AbstractClassifier {
		...
		protected EnsembleWithInfo(double alpha, int numClasses, Random classifierRandom, double theta, boolean isUOB, boolean isWMEnsemble, String name) {
