...
public class DDM extends AbstractChangeDetector {
    ...
    /**
     * michaelchiucw: Changed all the variables from private to protected because of
     * adding DDMGMeanBinaryProblems.java
     */
    protected int m_n;
    ...
    protected double m_psmin;

    protected double m_pmin;

    protected double m_smin;

    protected double warningLevel;

    protected double outcontrolLevel;
