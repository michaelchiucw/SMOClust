...
public class BasicClassificationPerformanceEvaluator extends AbstractOptionHandler
    ...
    //TODO
    public FlagOption gMeanOutputOption = new FlagOption("gMeanOutput",
            'g',
            "Output G-Mean.");
    ...
    public void reset(int numClasses) {
        ...
        //TODO
        this.totalWeightObservedEachClass = new double[numClasses];
        for (int i = 0; i < this.numClasses; i++) {
            ...
            //TODO
            this.totalWeightObservedEachClass[i] = 0;
        }
    ...
    public Measurement[] getPerformanceMeasurements() {
        ...
        for (int i = 0; i < numClasses; i++) {
        	measurements.add(new Measurement("classified instances of class " + i,
        				this.getTotalWeightObserved(i)));
        }
        ...
        //TODO Gmean
        if (gMeanOutputOption.isSet())
        	measurements.add(new Measurement("Gmean (percent)",
        			100.0 * this.getGMeanStatistic()));
