...
public class BasicAUCImbalancedPerformanceEvaluator extends AbstractOptionHandler
	...
	public Measurement[] getPerformanceMeasurements() {
		return new Measurement[] { new Measurement("classified instances", this.totalObservedInstances),
				...
				new Measurement("classifications correct (percent)", this.aucEstimator.getAccuracy() * 100.0),
				new Measurement("Kappa Statistic (percent)", this.aucEstimator.getKappa() * 100.0),
				new Measurement("Pos/Neg ratio", this.aucEstimator.getRatio()),
				new Measurement("G-Mean", this.aucEstimator.getGMean() * 100.0),
				new Measurement("Recall", this.aucEstimator.getRecall() * 100.0),
				new Measurement("Kappa M Statistic (percent)", this.aucEstimator.getKappaM() * 100.0) };
