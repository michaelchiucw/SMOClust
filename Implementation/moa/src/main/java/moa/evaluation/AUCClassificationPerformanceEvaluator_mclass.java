 ...
 * @version $Revision: 7 $
 */
public class AUCClassificationPerformanceEvaluator_mclass extends AbstractOptionHandler implements ClassificationPerformanceEvaluator {
  ...
  public Measurement[] getPerformanceMeasurements() {
	  return new Measurement[] {
			  new Measurement("classified instances", this.totalObservedInstances),
