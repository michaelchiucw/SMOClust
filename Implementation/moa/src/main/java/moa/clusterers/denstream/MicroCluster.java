...
public class MicroCluster extends CFCluster {
    ...
    public MicroCluster(double[] center, int dimensions, long creationTimestamp, double lambda, Timestamp currentTimestamp, boolean isRecordTimeStamp) {
        super(center, dimensions, creationTimestamp, isRecordTimeStamp);
    ...
    public MicroCluster(Instance instance, int dimensions, long timestamp, double lambda, Timestamp currentTimestamp, boolean isRecordTimeStamp) {
        this(instance.toDoubleArray(), dimensions, timestamp, lambda, currentTimestamp, isRecordTimeStamp);
    }

    @Override
    public void insert(Instance instance, long timestamp, boolean isRecordTimeStamp) {
//        N++;
    	super.insert(instance, timestamp, isRecordTimeStamp);
...
//        }
    ...
    public MicroCluster copy() {
        MicroCluster copy = new MicroCluster(this.LS.clone(), this.LS.length, this.getCreationTime(), this.lambda, this.currentTimestamp, true);
