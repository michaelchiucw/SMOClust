...
public class ClustreamKernel extends CFCluster {
    ...
    public ClustreamKernel( Instance instance, int dimensions, long timestamp, boolean isRecordTimeStamp, double t, int m) {
//        super(instance, dimensions);
        super(instance, dimensions, timestamp, isRecordTimeStamp);
        this.t = t;
        this.m = m;
        this.LST = timestamp;
