...
public class OptionsHandler extends JavaCLIParser {
    ...
    public void prepareClassOptions(TaskMonitor monitor,
        ...
        prepareClassOptions(optionArray, monitor, repository);
    }
    
    public void prepareAdditionalClassOptions(Option[] optionArray) {
    	prepareAdditionalClassOptions(optionArray, new NullMonitor(), null);
    }
    public void prepareAdditionalClassOptions(Option[] optionArray, TaskMonitor monitor,
            ObjectRepository repository) {
    ...
    public void prepareClassOptions(Option[] optionArray, TaskMonitor monitor,
            ObjectRepository repository) {
    	for (Option option : optionArray) {
