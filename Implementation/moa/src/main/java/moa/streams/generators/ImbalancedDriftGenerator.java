...
//    // TODO: development use
//    public int getInstanceSeed() {
//    	return this.instanceRandomSeedOption.getValue();
//    }
//    
//    public int getModelSeed() {
//    	return this.modelRandomSeedOption.getValue();
//    }
...
//	        			TODO: targetCenters[centroidIdx][radiusIdx] = (2*randomness.nextDouble()-1)*(1-border);
	        			targetCenters[centroidIdx][radiusIdx] = (4.0*randomness.nextDouble()-2.0)*(1.0-border);
	        		}
		            foundPlacement = true;
...
//			System.out.println("targetCenters: " + Arrays.deepToString(targetCenters));
		}
    }
...
//    				TODO: joinPoint[i] = randomness.nextDouble() - 0.5;
    				joinPoint[i] = 2.0*randomness.nextDouble() - 1.0;
    			}
    			foundPlacement = true;
    			for(Centroid centroid : distribution.centroids) {
    ...
    // <--- mc: to pause the progress and generate test sets.
    private boolean isPauseProgress = false;
    
    public void pauseProgress() {
//    	System.out.println("Pause | instancePast: " + this.instancesPast);
    	this.isPauseProgress = true;
    }
    
    public void resumeProgress() {
//    	System.out.println("Resume | instancePast: " + this.instancesPast);
    	this.isPauseProgress = false;
    }
...
//				this.drifts[i].randomness = this.instanceRandom;
				this.drifts[i].randomness = this.modelRandom;
